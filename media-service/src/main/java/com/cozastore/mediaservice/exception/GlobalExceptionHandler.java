package com.cozastore.mediaservice.exception;

import com.cozastore.mediaservice.payload.ResponseError;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseError handleMediaException(Exception ex, WebRequest request){
        log.info(ex.getMessage());
        return ResponseError
                .builder()
                .timestamp(new Timestamp(System.currentTimeMillis()))
