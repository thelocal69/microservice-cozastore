        ...
        return CompletableFuture.supplyAsync(
                () -> {
                    if (this.tagRepository.findAll().isEmpty()){
                        ...
                        throw new NotFoundException("Get list tag is empty !");
                    }
        ...
        return CompletableFuture.supplyAsync(
                () -> {
                    ...
                    if (!this.blogRepository.existsById(tagDTO.getBlogId())){
                        ...
                        throw new NotFoundException("Blog id not exist ! Cannot create !");
                    }
                    if (!productClient.checkProduct(request.getHeader("Authorization"), tagDTO.getProductId())){
                        ...
                        throw new NotFoundException("Product id not exist ! Cannot create !");
                    }
        ...
        return CompletableFuture.supplyAsync(
                () -> {
                    if (!tagRepository.existsById(id)){
                        ...
                        throw new NotFoundException("Tag is not exist ! Cannot delete !");
                    }
